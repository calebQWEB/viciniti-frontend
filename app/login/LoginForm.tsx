    ...
    <div className="min-h-screen bg-earth-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="card p-8">
          ...
          {/* Google OAuth */}
          <button className="w-full flex items-center justify-center gap-3 py-4 px-6 rounded-2xl border-2 border-earth-200 hover:border-primary-200 hover:bg-primary-50 transition-all font-semibold text-gray-700">
