        ...
        <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-10">
          ...
          <div className="mb-8 max-w-3xl">
            ...
            <p className="mt-2 text-sm leading-6 text-gray-500 sm:text-base">
              Update your service details, photos, location, or availability.
                  ...
                  <div>
                    ...
                    {errors.title ? (
                        ...
                        <p className="mt-2 text-[11px] text-gray-400">
                          Use a clear title that tells clients exactly what
                          service you provide.
                        </p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {errors.description ? (
                        ...
                        <div className="mt-2 flex items-center gap-1.5 text-[11px] text-gray-400">
                          ...
                          A detailed description helps clients understand what
                          they can expect from your service.
                        </div>
                    )}
                  </div>
                </div>
                ...
                <div className="p-5 sm:p-6">
                  ...
                  <div className="mt-4 flex items-start gap-2 rounded-xl bg-gray-50 p-3">
                    ...
                    <p className="text-[11px] leading-5 text-gray-500">
                      ...
                      ones. Use clear images that showcase your work or service
                      professionally.
                    </p>
                  </div>
                </div>
