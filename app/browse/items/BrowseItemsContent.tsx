...
export default function BrowseItemsContentPage() {
  ...
  const { data, isLoading, isFetchingNextPage, fetchNextPage, hasNextPage } =
    useInfiniteQuery({
      queryKey: ["listings", selectedCategory, location],
  ...
  // Flatten all pages into a single array and apply client-side search filter
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <p className="mt-2 text-sm sm:text-base text-gray-500">
            Find great deals on items near you
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12 sm:py-16 lg:py-20">
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-earth-100 rounded-3xl flex items-center justify-center mx-auto mb-4">
              <Search className="w-6 sm:w-8 h-6 sm:h-8 text-earth-300" />
            </div>
